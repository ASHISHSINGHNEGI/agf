...
export const metadata: Metadata = {
  ...
  description:
    "Anand Global Foods is a leading agri-export company with 14+ years of global experience, exporting premium Basmati Rice, Sugar, Tea, Coffee, and Spices to 93+ countries.",

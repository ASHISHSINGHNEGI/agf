        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-10 border border-gray-100">
          ...
          {submitted ? (
            <div className="flex flex-col items-center justify-center py-16 text-center gap-4">
              ...
              <h3 className="text-xl font-bold text-primary">Your email client is opening!</h3>
              <p className="text-gray-500 max-w-sm">
                Your inquiry has been pre-filled in your email app. Hit <strong>Send</strong> to submit it to our team — we'll respond within 24 hours.
              </p>
              <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  >
                    ...
                    <option value="Basmati & Non-Basmati Rice">Basmati &amp; Non-Basmati Rice</option>
                    <option value="Refined Sugar">Refined Sugar</option>
                    <option value="Black Tea">Black Tea</option>
                    <option value="Coffee">Coffee</option>
                    <option value="Whole & Ground Spices">Whole &amp; Ground Spices</option>
                    <option value="Other Agri Commodities">Other Agri Commodities</option>
                  </select>
                </div>
        ...
        <div className="bg-primary text-white rounded-2xl shadow-xl p-8 sticky top-28">
          ...
          <div className="space-y-8">
            ...
            <div className="border-t border-white/10 pt-6">
              <p className="text-sm text-gray-400 mb-3">Want a full overview of our products &amp; services?</p>
              <a
